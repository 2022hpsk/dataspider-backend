...
def run_spider(spider: str, params: Dict[str, str], timeout: int = 60*30) -> Optional[str]:
    ...
    try:
        ...
        with subprocess.Popen(
            ...
            if proc.returncode != 0:
                logger.error("Spider process exited with code %s, see %s", proc.returncode, logfile)
                return None
